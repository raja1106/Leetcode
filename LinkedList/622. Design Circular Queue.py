...
class MyCircularQueue_2025:
    ...
    def enQueue(self, value: int) -> bool:
        if self.size == self.k:
            return False
        self.size += 1
        current_rear_position = (self.rear + 1) % self.k
        self.arr[current_rear_position] = value
        self.rear = current_rear_position
        return True
    ...
    def deQueue(self) -> bool:
        if self.size == 0:
            return False
        self.size -= 1
        current_front_position = (self.front + 1) % self.k
        # self.arr[current_front_position] = value
        self.front = current_front_position
        return True
